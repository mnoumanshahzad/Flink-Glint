...
class ALSGlint extends Predictor[ALSGlint] {
  ...
  /** Sets the number of latent factors/row dimension of the latent model
    ...
    * @return
    */
  def setNumFactors(numFactors: Int): ALSGlint = {
  ...
  /** Sets the regularization coefficient lambda
    ...
    * @return
    */
  def setLambda(lambda: Double): ALSGlint = {
    parameters.add(Lambda, lambda)
    this
  }

  /** Sets the number of iterations of the ALSGlint algorithm
    *
    * @param iterations
    * @return
    */
  def setIterations(iterations: Int): ALSGlint = {
  ...
  /** Sets the number of blocks into which the user and item matrix shall be partitioned
    ...
    * @return
    */
  def setBlocks(blocks: Int): ALSGlint = {
  ...
  /** Sets the random seed for the initial item matrix initialization
    ...
    * @return
    */
  def setSeed(seed: Long): ALSGlint = {
  ...
  /** Sets the temporary path into which intermediate results are written in order to increase
    ...
    * @return
    */
  def setTemporaryPath(temporaryPath: String): ALSGlint = {
...
object ALSGlint {
  ...
  implicit val predictRating = new PredictDataSetOperation[
    ...
    : DataSet[(Long, Long, Double)] = {
      ...
      instance.factorsOption match {
        ...
        case None => throw new RuntimeException("The ALSGlint model has not been fitted to data. " +
          "Prior to predicting values, it has to be trained on data.")
      }
    }
  }

  implicit val predictRatingInt = new PredictDataSetOperation[ALSGlint, (Int, Int), (Int, Int, Double)] {
    override def predictDataSet(
                                 instance: ALSGlint,
                                 predictParameters: ParameterMap,
    ...
    : DataSet[(Int, Int, Double)] = {
      ...
      val longResult = implicitly[PredictDataSetOperation[ALSGlint, (Long, Long), (Long, Long, Double)]]
        .predictDataSet(
          instance,
          predictParameters,
          longInput)
  ...
  /** Calculates the matrix factorization for the given ratings. A rating is defined as
    ...
    */
  implicit val fitALS =  new FitOperation[ALSGlint, (Long, Long, Double)] {
    override def fit(
                      instance: ALSGlint,
    ...
    : Unit = {
      ...
      // GLINT-Start Matrix Initialize
      val matrix = client.matrix[Double](10000, 2000)
      Await.result(matrix.push(Array(0L, 1L, 2L), Array(100, 200, 300), Array(0.1, 3.1415, 9.999)), 30 seconds)
  ...
  implicit val fitALSInt =  new FitOperation[ALSGlint, (Int, Int, Double)] {
    override def fit(
                      instance: ALSGlint,
                      fitParameters: ParameterMap,
    ...
    : Unit = {
      ...
      implicitly[FitOperation[ALSGlint, (Long, Long, Double)]].fit(instance, fitParameters, longInput)
    }
  }
